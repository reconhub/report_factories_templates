...
author: "Charlie Whittaker, Christopher Jarvis,  Thibaut Jombart, Flavio Finger, Jonathan Polonsky, Patrick Keating, and Amy Gimma for the analytic cell OEC Mangina"
...
ggplot(x_prop, aes(x = epiweek_report_label, col = "#D56F3E")) +
  ...
  labs(x = "",
       ...
       title = paste0("Proportion d'alertes validées par semaine - Mangina")) +
  large_txt +
  rotate_x_text(45) +
  theme(legend.position = "bottom") +
  scale_months
...
ggplot(data = x_alert_rate_sous_co, 
  ...
  labs(x = "",
       ...
       title = paste0("Nombre d'alertes par 10000 personnes pour \n", 
                      "le sous-coordination de Mangina")) +
  large_txt +
  rotate_x_text(45) +
  theme(legend.position = "bottom") +
  scale_months
