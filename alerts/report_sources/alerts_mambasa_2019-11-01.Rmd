...
author: "Charlie Whittaker, Christopher Jarvis,  Thibaut Jombart, Flavio Finger, Jonathan Polonsky, Patrick Keating, and Amy Gimma for the analytic cell OEC Mambasa"
...
## zone de sante
x <- mutate(x, zone_de_sante = as.character(z_s)) 
...
## origin / source_notif
x <- mutate(x, origin = typ_transmission)
...
ggplot(x_prop, aes(x = epiweek_report_label, col = "#D56F3E")) +
  ...
  labs(x = "",
       ...
       title = paste0("Proportion d'alertes validées par semaine - Mambasa")) +
  large_txt +
  rotate_x_text(45) +
  theme(legend.position = "bottom") +
  scale_months
...
ggplot(x_validations, aes(x = aire_de_sante, y = n, fill = status)) +
  ...
  labs(x = "",
       y = "Nombre d'alertes",
       title = "Nombre d'alertes par statut de validation et aire de santé",
       subtitle = "avec moins que 100 alertes") +
  theme(legend.position = "bottom") +
  large_txt +
  rotate_x_text(45)
...
ggplot(x_origins, aes(x = aire_de_sante, y = n, fill = origin)) +
  ...
  labs(x = "",
       y = "Nombre d'alertes",
       title = "Nombre d'alertes par origine et aire de santé",
       subtitle = "avec plus de 100 alertes") +
  theme(legend.position = "bottom") +
  large_txt +
  rotate_x_text(45)
...
ggplot(x_origins, aes(x = aire_de_sante, y = n, fill = origin)) +
  ...
  labs(x = "",
       ...
       title = paste("Nombre d'alertes par origine et aire de santé",
                     "\ndepuis les 3 semaines dernières"),
       subtitle = "avec moins que 20 alertes") +
  theme(legend.position = "bottom") +
  large_txt +
  rotate_x_text(45)
...
ggplot(data = x_alert_rate_sous_co, 
  ...
  labs(x = "",
       ...
       title = paste0("Nombre d'alertes par 10000 personnes pour \n", 
                      "le sous-coordination de Mambasa")) +
  large_txt +
  rotate_x_text(45) +
  theme(legend.position = "bottom") +
  scale_months
