...
There are `r nrow(unknown_as)` unknown aire de santes with the latest being `r most_recent_unknown_as`. There are `r nrow(unknown_as_3weeks)` alerts with an unknown aire de santes in the database.
...
to_export <- c("table_validation_overall_time",
               "table_validation_overall_past_3_weeks",
               "table_hz_total_validation",
               "table_hz_over_time_validation",
               "table_hz_total_recent_validation",
