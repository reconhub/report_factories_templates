...
author: "Charlie Whittaker, Christopher Jarvis,  Thibaut Jombart, Flavio Finger, Jonathan Polonsky, Patrick Keating, and Amy Gimma for the analytic cell OEC Butembo"
...
ggplot(data = x_alert_rate_sous_co, 
  ...
  labs(x = "",
       ...
       title = paste0("Nombre d'alertes par 10000 personnes pour \n", 
                      "le sous-coordination de Butembo")) +
  large_txt +
  rotate_x_text(45) +
  theme(legend.position = "bottom") +
  scale_months
