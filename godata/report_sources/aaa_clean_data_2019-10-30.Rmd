...
<div class="report_meta">
  ...
  **Code contributors:** Sara Hollis, Thibaut Jombart
...
cases <- cases %>%
  mutate(date_of_reporting = guess_dates(date_of_reporting),
        ...
        ## date_of_becoming_contact = guess_dates(date_of_becoming_contact),
...
followups <- followups %>%
  mutate(date_of_data_entry = guess_dates(created_at),
         ...
         ##date_of_case_notification = guess_dates(datenotification),
...
Here we ensure that all age info is captured in one field `age_years` across all datasets.
...
## export cases relationships file
...
* first version
* reads in: *cases*, *contacts*, *relationships*
