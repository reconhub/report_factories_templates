...
hierarchy <- clean_data(hierarchy)
...
mutate(
  ...
  x1 <- left_join(contacts, hierarchy_join, by = c("location_1" = "name_6"))
  x1$name_6[!is.na(x1$name_5)] <- x1$location_1[!is.na(x1$name_5)]
  # repeat but with filters to acheve the rest
