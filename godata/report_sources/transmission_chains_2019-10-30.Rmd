...
* the *cases_relationships* database, describing transmission chains using unique
...
## load the chains
current_clean_cases_relationships
chains <- rio::import(current_clean_cases_relationships) %>%
    as_tibble()
chains
...
chains_file_name <- gsub("^[^.]+/", "", current_clean_cases_relationships)
...
* the *cases_relationships* database stored as `chains`
