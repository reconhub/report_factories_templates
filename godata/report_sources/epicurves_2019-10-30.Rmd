...
various stratification, from the cleaned Godata database.

### Data used

This report uses the latest cleaned case export from the Godata database.
...
* **Add new variables**: addition of new variables to the Godata database, like top
  affected health zones.

* **Filter the data**: Various filters to data possibly
...
In this section we can subset the data to look at only confirmed and probable cases, for instance. For now we will leave suspect cases in too.

* `cases` contains confirmed, probable and suspect cases

```{r filter}

cases <- x %>%
  filter(classification %in% c("confirmed", "probable", "suspect"))
...
* confirmed/probable/suspect (`classification` variable)
...
plot(i_report_classification, border = "white") +
  ...
  theme(legend.title = element_blank(),
        ...
        legend.background = element_rect(fill = "transparent", 
                                         color = "white")) +
  labs(title = paste0("Courbe épidemique: cas confirmés, probables et suspect",
