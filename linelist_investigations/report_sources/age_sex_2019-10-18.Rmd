...
<!-- ======================================================= -->
## By month and recent major health zone
...
* `produced_xlsx/tab_overall.xlsx`: tab_overall contains the overall distributions of cases by sex.

* `produced_xlsx/tab_sub_coordination.xlsx`: tab_sub_coordination contains the overall distributions of 
cases by sex and sous coordination.

* `produced_xlsx/tab_top_zones.xlsx`: tab_top_zones contains the overall distributions of cases by sex 
...
* `produced_rds/tab_overall.rds`: tab_overall contains the overall distributions of cases by sex.

* `produced_rds/tab_sub_coordination.rds`: tab_sub_coordination contains the overall distributions of 
cases by sex and sous coordination. 

* `produced_rds/tab_top_zones.rds`: tab_top_zones contains the overall distributions of cases by sex 
in health zones with the most cases during the last 42 days. 
