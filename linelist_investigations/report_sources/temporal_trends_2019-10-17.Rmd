...
ggplot(hcw_overall_time, aes(x = month_report, y = p)) +
        ...
        rotate_x_text(45) +
        large_txt +
        labs(title = "Proportion de cas qui sont des travailleurs de la sant�",
             x = "Mois de notification",
             y = "% de cas mensuels")
...
table_hcw_overall <- hcw_overall %>% 
  select("% travailleurs de la sant�" = p,
        "IC95% lower" = p_lower,
        "IC95% upper" = p_upper,
        n = denom,
        everything())
...
ggplot(hcw_sub_coordination, aes(x = sous_coordination, y = p)) +
  ...
  labs(title = "Proportion de cas qui sont des travailleurs de la sant�\npar sous-coordination",
          x = "",
          y = "% de cas qui sont des travailleurs de la sant�")
