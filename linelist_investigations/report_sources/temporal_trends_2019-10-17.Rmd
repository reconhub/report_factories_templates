...
author: "Thibaut Jombart, Christopher Jarvis, Jonathan Polonsky, Amy Gimma, Arthur Fitzmaurice for the analytic cell EOC Goma"
...
completeness <- 100*rbind(known_contact = contacts_overall$denom / contacts_overall$total,
                          followed = followed_overall$denom / followed_overall$total,
                          community_deaths = community_deaths_overall$denom / community_deaths_overall$total,
                          hcw_cases = hcw_overall$denom / hcw_overall$total)

completeness <- data.frame(labels = factor(rownames(completeness), levels=rownames(completeness)), completeness)
