...
author: "Thibaut Jombart, Christopher Jarvis, Jonathan Polonsky, for the analytic cell EOC Goma"
...
<div class="report_meta">
  ...
  **Code contributors:** Christopher Jarvis, Thibaut Jombart, Amy Gimma
...
ignores the first column of data assuming it is a grouping factor. This will no
...
4. plot temporal trends, retaining only sub-coordinations for which the average
   monthly uncertainty is is less than 60%
